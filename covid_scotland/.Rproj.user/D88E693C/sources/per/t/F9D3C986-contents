## Script Information -------------------------------------------------------
##
## Script name:  hospital_ativity_and_deprivation_clean.R
##
## Purpose of script: 
...
##  for the variables like shb and location, for that reason three auxiliary 
##  dataset were joined:
...
## 
## Output:
##        activity_deprivation.csv - cleaned file of raw data
##                      
## 
##
##/////////////////////////////////////////////////////////////////////////////
...
##
##    Data file require:
##        hospital_ativity_and_deprivation.csv
##        hospitals.csv
...
activity_deprivation %>% 
  write.csv(here::here("02_cleaned_data/activity_deprivation.csv"))
